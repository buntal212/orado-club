...
.section-label { margin: 35px 2px 10px; color: #24483e; font-size: 9px; font-weight: 800; letter-spacing: .5px; }.menu-panel { padding: 10px; border: 1px solid #dce9e4; border-radius: 15px; background: #fff; box-shadow: 0 4px 14px rgba(3, 73, 53, .05); }.menu-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 9px; }.menu-card { min-height: 84px; border-radius: 11px; background: #fdfffe; }.menu-card :deep(.q-card__section) { display: flex; height: 100%; flex-direction: column; align-items: center; justify-content: center; gap: 6px; padding: 8px 3px; color: #1e4d3f; font-size: 9px; text-align: center; }
.menu-card--clickable { cursor: pointer; }.menu-card--clickable:active { background: #effaf5; transform: translateY(1px); }
.bottom-nav { position: fixed; right: 0; bottom: 0; left: 0; z-index: 5; display: flex; justify-content: center; gap: 40px; padding: 9px 12px calc(9px + env(safe-area-inset-bottom)); background: #006b4f; }.nav-item { display: flex; min-width: 58px; flex-direction: column; align-items: center; gap: 2px; padding: 2px 8px; border: 0; color: rgba(255,255,255,.72); background: transparent; font: inherit; font-size: 8px; cursor: pointer; }.nav-item .q-icon { font-size: 19px; }.nav-item--active { color: #fff; font-weight: 700; }
</style>
